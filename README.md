...
To do this, I used serial communication. I wrote a python program called valuesRead.py to read the values from the text file and write them to the LED matrix
